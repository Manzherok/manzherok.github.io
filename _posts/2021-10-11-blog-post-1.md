...
*Proof*. See the article on [nLab](https://ncatlab.org/nlab/show/paracompact+spaces+satisfying+the+countable+chain+condition+are+Lindel%C3%B6f).
<p align=right>
∎
</p>

> **Theorem**. Let $X$ be a Lindelöf topological space. If $X$ is also normal, then it is paracompact.
*Proof*. See the following article from the [American Math Society](https://www.ams.org/journals/proc/1957-008-04/S0002-9939-1957-0087079-9/S0002-9939-1957-0087079-9.pdf).

<p align=right>
∎
</p>

## Nice Spaces are Paracompact
Usually the topological spaces that are conveinent to work in turn out to be paracompact, including metric spaces. The proof that all metric spaces are paracompact was refined by Mary Ellen Rudin, the wife of the famous Walter Rudin, author of *Principles of Mathematical Analysis*. We will link the proof here, though it does require some familiarity with ordinals. 

> **Theorem**. Metric spaces are paracompact.
*Proof*. See the following article from [Marry Ellen Rudin](https://www.ams.org/journals/proc/1969-020-02/S0002-9939-1969-0236876-3/S0002-9939-1969-0236876-3.pdf).
<p align=right>
∎
</p>