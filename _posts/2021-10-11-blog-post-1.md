...
$$K_x(\varepsilon)=\\[x - \varepsilon, x + \varepsilon\\]$$ serves as a "compact neighborhood" of $x$. As such, *any* open cover of $K_x(\varepsilon)$ can be dropped down to a finite subcover, whereby the open ball $B_x(\varepsilon) = (x - \varepsilon, x + \varepsilon)$ intersects only finitely many open sets in this finite subcover, for obvious reasons.
\
